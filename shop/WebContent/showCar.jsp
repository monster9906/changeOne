		...
		$(function(){
			$(".text").change(function(){
				...
				if( !isNaN(number)  && parseInt(number)==number && number>0  ){
					...
					// 更新小计
					var price = $(this).parent().prev().attr("lang")*number;
...
<body>
	<div class="wrapper">
		...
		<div class="section_container">
			<!-- 购物车 -->
			<c:if test="${empty forder}">
			<div id="shopping_cart">
				<div class="action_buttonbar">
						<h1>空空如也！</h1>
						<button type="button" title="" onclick="gowu()" class="continue fr">
							<font><font>继续购物</font>
							</font>
						</button>
			...
			<div id="shopping_cart">
				...
				<table class="data-table cart-table" cellpadding="0" cellspacing="0">
					...
					<tr lang="${sorder.product.id}">
						...
						<td class="align_center vline" lang="${sorder.price}"><span class="price">￥${sorder.price}</span>
						</td>
				...
				<!-- 结算 -->
					...
					<table id="totals-table">
						<tbody>
							...
							<tr>
								...
								<td class="align_right" style="">￥:<span class="total" id="total"><strong>${forder.total}</strong>
								</span>
								</td>
							</tr>
						</tbody>
					...
					<div class="action_buttonbar">
						<button type="button" title="" class="checkout fr"
							...
							<font><font><a href="${shop}/user/confirm.jsp" style="color: #fff">订单确认</a></font>
							</font>
						</button>
