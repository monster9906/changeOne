	...
	<div class="wrapper">
			...
			<div class="header_container">
				...
				<div class="top_bar clear">
					...
					<div class="minicart">
						...
						<%-- ${fn:length(sessionScope.forder.sorderList)}
						<b>|${sessionScope.forder.number}</b>件/ </span> <span class="price"> <b>￥${sessionScope.forder.total}</b> </span> </a>
						 --%>
					</div>
					<!-- 小购物车结束 -->
					<!-- 搜索框 -->
		...
		<div class="section_container">
			...
			<div id="dd" class="action_buttonbar" style="text-align:center;">
				<form id="ff" method="post" action="${shop}/user_register.action">
					<div>
					...
					<div>
						<label for="pass">确认密码:&nbsp</label> 
						<input type="password" name="confirm_password" />
					</div>
					<div>
						<label for="pass">姓名:&nbsp</label> 
						<input type="text" name="name" />
					</div>
					<div style="margin-left: -119px">
						<label for="pass">性别:&nbsp</label> 
						<input type="radio" name="sex" value="男"/>男
						<input type="radio" name="sex" value="女"/>女
					</div>
					<div>
						<label for="pass">电话:&nbsp</label> 
						<input type="text" name="phone" />
					</div>
					<div>
						<label for="pass">邮件:&nbsp</label> 
					...
					<div>
						<input type="submit" value="注 册" style="width:60px;height:30px" />
						<input type="reset" value="重 置" style="width:60px;height:30px"/>
					</div>   
			   </form>
